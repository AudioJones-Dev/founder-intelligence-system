...
|---|---|---|
| `map-attribution-analysis.md` | `ais_diagnostic_agent` (M.A.P. mode) | active |
| `signal-audit.md` | `ais_diagnostic_agent` (Signal Audit mode) | active |
| `founder-prediction-error.md` | `ais_diagnostic_agent` (Founder Prediction Error mode) | active |
